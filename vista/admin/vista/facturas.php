    ...
    <div class="content">
        ...
        <div class="contact-wrapper-compras">               
            <div class="contact-form-compras">
                ...
                <input type="text" name="evento" placeholder="buscar por evento" id="evento" value="" onkeyup="buscarPorEvento()" style="display:block; margin:0 auto; padding:0px 85px; border-radius:5px; width:100%; border-style:solid; border-color:black;">
   				 </form>
