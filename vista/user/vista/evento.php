...
<body>
	...
	<main class="main">
		<form action="" class="busqueda" style="display:block;background:white; padding:10px 0;">
                ...
                <input type="text" name="correo" placeholder="buscar por remitente" id="correo" value="" onkeyup="buscarPorCorreo()" style="display:block; margin:0 auto; padding:5px 15px; border-radius:5px;">
            </form>
